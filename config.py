...
# Kelly fraction. Doubled from 0.125 to 0.25 (quarter-Kelly) on 2026-06-09.
# Model has shown +15% ROI on bets outside the +1260 outlier (now blocked by
# MAX_AMERICAN_ODDS cap). Sample still building toward 50 bets.
KELLY_FRACTION = 0.25
